...
export default {
    ...
    plugins: [
        ...
        new CopyWebpackPlugin({
            patterns: [{ from: './style/unwrap/unwrap_images/unwrap.svg', to: './style/unwrap/unwrap_images' },
            { from: './style/brends/brends_images', to: './style/brends/brends_images' },
            { from: './style/logo/logo_images', to: './style/logo/logo_images' },
            { from: './style/table/table_images', to: './style/table/table_images' },
