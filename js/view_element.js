const btnArr = [
  document.querySelector(".unwrap-btn--type--brends"),
  document.querySelector(".unwrap-btn--type--equipment"),
];
...
class Changes {
  ...
  changes_element() {
    ...
    const boolean_toggle = this.changer.classList.contains(
      "unwrap-btn--action--open",
    );
  ...
  changing_height(flag) {
    flag
      ? ((this.changing.style.height = this.changing.scrollHeight + "px"),
        (this.changer_children_span.textContent = "Скрыть"))
